# R-Intro_2017.R
#
# Purpose: Introduction to R workshop. CBW -2017 version
#
# Version: 1.0
#
# Date:    2017  05
...
#TOC> ----------------------------------------------------------------------
#TOC>   1        INTRODUCTION                                             95
#TOC>   1.1        Assigning variables                                    98
#TOC>   1.2        Digression: Configuring startup behaviour ...         127
#TOC>   1.2.1          Task: a simple function; configuring R            152
#TOC>   1.3        DATA TYPES ...                                        174
#TOC>   1.3.1          Scalars                                           176
#TOC>   1.3.1.1        Task: Language keywords                           192
#TOC>   1.3.2          Vectors                                           220
#TOC>   1.4        A source of data ...                                  241
#TOC>   1.4.1          Task: Getting data into R                         254
#TOC>   1.4.2          Task: Working with strings                        277
#TOC>   2        Storing data in R                                       298
#TOC>   2.1        Lists                                                 302
#TOC>   2.2        Dataframes - from csv or tsv data                     331
#TOC>   2.2.1          Task: Read supplementary table S3 from Excel      411
#TOC>   2.2.2          Digression: Factors in dataframes                 438
#TOC>   2.2.3          Task: Fix problems of the "LPSdat" dataframe      499
#TOC>   2.3        First view of the S3 data                             510
#TOC>   2.3.1          Task: characteristic genes?                       590
#TOC>   3        Programming basics                                      609
#TOC>   3.1        Conditionals                                          618
#TOC>   3.2        Loops                                                 687
#TOC>   3.2.1          for loop                                          689
#TOC>   3.2.2          while loop                                        714
#TOC>   3.2.3          Digression: namespaces                            771
#TOC>   3.2.4          Task: vectorize a previously written function     793
#TOC>   3.3        Task: more analysis of data                           808
#TOC>   4        Basic Analysis                                          819
#TOC>   4.1        Subsetting data - Review of the principles            824
#TOC>   4.1.1          A sample dataset                                  833
#TOC>   4.1.2          Subsetting by index                               876
#TOC>   4.1.2.1        Negative indices                                  920
#TOC>   4.1.3          Subsetting by logical                             931
#TOC>   4.1.3.1        Filtering by string matching expressions          984
#TOC>   4.1.4          Subsetting by name                               1002
#TOC>   4.1.5          The "$" operator                                 1035
#TOC>   4.2        Subsetting data - tasks                              1056
#TOC>   4.2.1          Example - Heatmap of a subset                    1336
#TOC>   5        Outlook, and further practice                          1362
#TOC>   5.1        Task: more analyis to consolidate concepts           1382
#TOC> 
#TOC> ==========================================================================
